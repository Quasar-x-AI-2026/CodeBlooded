        ...
        try {
            ...
            navigator.geolocation.getCurrentPosition(
                ...
                (error) => {
                    ...
                    alert(
                        'Location access is required to capture images. Please enable location permissions.'
                    );
                }
            );
        } catch (error) {
        ...
        try {
            ...
            if (uploadedImages.length > 0) {
                ...
                const uploadRes = await fetch(
                    `${import.meta.env.VITE_SERVER_URL}/api/v1/ngo/upload-images`,
                    {
                        method: 'POST',
                        credentials: 'include',
                        body: formData,
            ...
            const payload = {
                ...
                contributors: form.contributors
                    ...
                    : [],
                // issueSolved should be an Issue ObjectId or undefined
                issueSolved:
                    form.issueSolved && form.issueSolved !== 'false'
                        ? form.issueSolved
                        : undefined,
            };

            const res = await fetch(
                `${import.meta.env.VITE_SERVER_URL}/api/v1/ngo/report-submission`,
                {
                    method: 'POST',
                    headers: {
                    ...
                    <defs>
                        ...
                        >
                            <stop
                                offset="0%"
                                style={{
                                    stopColor: 'var(--accent-green-lighter)',
                                    stopOpacity: 0.3,
                                }}
                            />
                            <stop
                                offset="100%"
                                style={{
                                    stopColor: 'var(--accent-green-light)',
                                    stopOpacity: 0.1,
                                }}
                            />
                        </linearGradient>
                ...
                <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="text-center space-y-3 pb-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Document your relief work and share the impact
                            created with funds received
                        </p>
                    </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Basic information about your relief
                                        efforts
                                    </p>
                                </div>
                            </div>
                        ...
                        <Card className="p-6 space-y-4 border-border shadow-md bg-gradient-to-br from-[var(--accent-green-lighter)] via-[var(--accent-green-light)] to-card backdrop-blur-sm">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Total capital deployed for this relief
                                        work
                                    </p>
                                </div>
                            </div>
                        ...
                        <Card className="p-6 space-y-4 border-border shadow-md bg-card backdrop-blur-sm">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Capture photos from your camera with
                                        location data
                                    </p>
                                </div>
                            </div>
                                    ...
                                    {uploadedImages.map((img) => (
                                        ...
                                        >
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 bg-black/75 text-white text-[10px] px-2 py-1 rounded-b-lg">
                                                📍{' '}
                                                {img.location.latitude.toFixed(
                                                    4
                                                )}
                                                ,{' '}
                                                {img.location.longitude.toFixed(
                                                    4
                                                )}
                                            </div>
                                        </div>
